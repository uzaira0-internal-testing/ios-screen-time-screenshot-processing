...
setup("upload test screenshots", async ({ request }) => {
  ...
  // Find PNG files in P3-3006 folder (first 10)
  const p3Dir = path.join(dataDir, "P3-3006 Cropped");
  ...
  for (const imgPath of pngFiles) {
    ...
    const groupId = parts[0]; // e.g. 'P3-3006 Cropped'
    const participantId = parts[1]; // e.g. 'P3-3006_T1_10-1-23'
