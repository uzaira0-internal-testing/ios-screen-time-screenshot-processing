      ...
      <table className="w-full text-sm">
        <thead>
          <tr className="border-b border-gray-200 text-left text-gray-500">
            ...
            <th className="px-3 py-2 w-24">Cropped</th>
            <th className="px-3 py-2 w-24">Patched</th>
            <th className="px-3 py-2">Original Size</th>
            ...
            return (
              <tr key={s.id} className="border-b border-gray-100 hover:bg-gray-50">
                ...
                <td className="px-3 py-2 text-xs">
                  {dd?.device_category || s.device_type || "—"}
                </td>
                <td className="px-3 py-2">
                  {cr ? (
                    cr.was_cropped ? (
                ...
                <td className="px-3 py-2 text-xs text-gray-600">
                  {cr?.original_dimensions
                    ? `${cr.original_dimensions[0]} x ${cr.original_dimensions[1]}`
                    : "—"}
                </td>
                <td className="px-3 py-2">
                  <button
