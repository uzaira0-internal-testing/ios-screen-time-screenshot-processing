 ...
 */
export function parseRelativePath(file: File): { participant_id: string; screenshot_date: string; filename: string; original_filepath: string } {
  ...
  return (
    ...
    >
      ...
      <div className="space-y-3">
        ...
        <div className="text-xs text-slate-400 dark:text-slate-500 font-mono bg-slate-100 dark:bg-slate-800 rounded px-3 py-2 inline-block">
        ...
        <p className="text-xs text-slate-400 dark:text-slate-500">
          Date folders can use formats like 2024-01-15, 01.15.2024, Day_1_01.02.2025, etc.
        </p>
