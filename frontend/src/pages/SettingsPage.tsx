        ...
        <div className="bg-white border border-slate-200 rounded-lg p-6">
          ...
          <div className="grid md:grid-cols-3 gap-4 text-sm">
            <div className="bg-slate-50 p-3 rounded">
              ...
              <div className="text-slate-600 mt-1">Server Database</div>
            </div>
            <div className="bg-slate-50 p-3 rounded">
              <div className="font-medium text-slate-700">Processing</div>
              <div className="text-slate-600 mt-1">Backend (Python + Tesseract)</div>
            </div>
            <div className="bg-slate-50 p-3 rounded">
              <div className="font-medium text-slate-700">Network Required</div>
              <div className="text-slate-600 mt-1">Yes (Server Connection)</div>
            </div>
          </div>
        </div>
