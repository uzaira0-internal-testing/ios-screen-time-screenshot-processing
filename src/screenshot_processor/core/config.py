...
class OCRConfig:
    ...
    hunyuan_url: str = "http://cnrc-rtx4090.ad.bcm.edu:8080"
    ...
    paddleocr_url: str = "http://cnrc-rtx4090.ad.bcm.edu:8081"
...
def get_hybrid_ocr_config() -> OCRConfig:
    ...
    try:
        ...
        return OCRConfig(
            ...
            use_hybrid=settings.OCR_ENGINE_TYPE == OCREngineType.HYBRID,
        ...
        return OCRConfig(
            ...
            hunyuan_url=os.environ.get("HUNYUAN_OCR_URL", "http://cnrc-rtx4090.ad.bcm.edu:8080"),
            hunyuan_timeout=int(os.environ.get("HUNYUAN_OCR_TIMEOUT", "120")),
            paddleocr_url=os.environ.get("PADDLEOCR_URL", "http://cnrc-rtx4090.ad.bcm.edu:8081"),
