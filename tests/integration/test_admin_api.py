...
class TestDeleteGroup:
    ...
    CRITICAL: Group deletion must remove ALL related data to prevent orphans.
    """
    ...
    async def test_delete_group_removes_all_data(
        ...
        # CRITICAL: Verify ALL related data is deleted from database
...
class TestResetTestData:
    ...
    async def test_reset_clears_annotations(
        ...
        # CRITICAL: Verify annotations are cleared
    ...
    async def test_reset_clears_queue_states(
        ...
        # CRITICAL: Verify queue states are cleared
    ...
    async def test_reset_clears_verification(
        ...
        # CRITICAL: Verify verification is cleared
        await db_session.refresh(test_screenshot)
