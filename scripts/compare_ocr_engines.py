...
Usage:
    ...
    python scripts/compare_ocr_engines.py --input-dir ./data/P3-3006\ Cropped
...
def run_hunyuan_ocr(
    image_bytes: bytes,
    base_url: str = "http://cnrc-rtx4090.ad.bcm.edu:8080",
    timeout: int = 120,
...
def main():
    ...
    parser.add_argument(
        "--hunyuan-url",
        type=str,
        default="http://cnrc-rtx4090.ad.bcm.edu:8080",
