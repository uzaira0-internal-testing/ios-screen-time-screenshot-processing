...
def generate_python(data: dict, hash_val: str) -> str:
    ...
    lines.append(f"DARKEN_NON_WHITE_THRESHOLD: int = {pc['darken_non_white']['channel_sum_threshold']}")
    lines.append("")
...
def generate_typescript(data: dict, hash_val: str) -> str:
    ...
    lines.append(f"export const DARKEN_NON_WHITE_THRESHOLD = {pc['darken_non_white']['channel_sum_threshold']};")
    lines.append("")
